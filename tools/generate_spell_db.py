...
CLASS_ABILITIES_PAGES: dict[str, str] = {
...
def emit_lua(db: dict[str, dict[str, list[SpellRank]]]) -> str:
    out: list[str] = []
    out.append("-- Generated by tools/generate_spell_db.py; do not edit by hand.")
    out.append("SpellbookProSpellDB = {")
...
def main() -> int:
    ...
    for class_token, mask in CLASS_MASK.items():
        url = CLASS_ABILITIES_PAGES[class_token]
        page = fetch(url)
